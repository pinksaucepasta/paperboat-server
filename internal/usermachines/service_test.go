...
func TestConnectionDescriptorSerializesCanonicalPayload(t *testing.T) {
	...
	for _, forbidden := range []string{"user_machine_id", "user_machine_state", "paperboat_terminal_v2", "paperboat_staged_image_v1", "websocket_base_url", "http_base_url", `"upload"`} {
