...
var mandatoryExcludes = []string{
	...
	".pypirc", "**/.pypirc", ".gem/credentials", ".cargo/credentials", ".cargo/credentials.toml",
	...
	".config/glab-cli/config.yml", ".config/composer/auth.json", ".config/pip/pip.conf", ".config/uv/uv.toml",
	".claude/session-env", ".claude/projects", ".claude/shell-snapshots", ".claude/history.jsonl", ".claude/debug", ".claude/cache", ".claude/todos", ".claude/backups", ".claude/logs",
	".codex/sessions", ".codex/archived_sessions", ".codex/history.jsonl", ".codex/log", ".codex/tmp", ".cursor/auth.json", ".cursor/sessions", ".mcp.json",
	".config/opencode/sessions", ".config/opencode/logs", ".local/share/opencode/sessions", ".local/share/opencode/logs",
	...
	".npm/_cacache", ".npm/_logs", ".pnpm-store", ".yarn/cache", ".bun/install/cache", "**/cache", "**/caches", "**/log", "**/logs", "**/tmp", "**/temp",
	...
	"**/credentials", "**/credentials.*", "**/auth.toml", "**/auth.yml", "**/auth.yaml", "**/secrets.json", "**/secrets.yml", "**/secrets.yaml",
	".env", ".env.*", "**/.env", "**/.env.*", "**/*.db", "**/*.db-wal", "**/*.db-shm", "**/*.sqlite", "**/*.sqlite3", "**/*.sqlite-wal", "**/*.sqlite-shm", "**/*.log", "**/*.tmp", "**/*.bak", "**/*~", "**/.DS_Store",
}
